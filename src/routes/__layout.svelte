...
<div class="grid place-items-center h-screen">
	<div class="h-[800px] w-[400px]  rounded-2xl ring-2 ring-gray-100 flex flex-col bg-[#1E1E1E]">
		<TopBanner />
		...
		<!-- Navigation -->
		<div class="h-20 flex justify-around items-center rounded-2xl bg-[#ECECEC]">
			<div class="h-10">
				<Avatar />
			</div>
